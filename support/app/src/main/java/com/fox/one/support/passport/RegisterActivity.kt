...
import com.fox.one.support.passport.core.*
...
class RegisterActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btn_req_sms_code).setOnClickListener {
            ...
            PassportAPI.requestSMSCodeOfPhoneRegister(
                SMSCodeReqBody(
                    captcha = cap,
                    captchaId = captchaId,
                    countryCode = "86",
                ...
                .enqueue(object: Callback<SMSCodeResponse> {
                    override fun onFailure(call: Call<SMSCodeResponse>, t: Throwable) {
                        LogUtils.i("foxone", "${t.toString()}")
                    }

                    override fun onResponse(call: Call<SMSCodeResponse>, response: Response<SMSCodeResponse>) {
        ...
        findViewById<Button>(R.id.btn_register).setOnClickListener {
            ...
            PassportAPI.registerWithPhone(
                PhoneRegisterReqBody(
                    nickName = name,
                ...
                .enqueue(object: Callback<AccountInfo> {
                    ...
                    override fun onResponse(call: Call<AccountInfo>, response: Response<AccountInfo>) {
                        DemoApp.onLogin(this@RegisterActivity, response.body()?: AccountInfo())
