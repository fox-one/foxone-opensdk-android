...
public class SecurityUtils {
    ...
    public static class SHA1 {
        public static String encrypt(String s) {
            try {
                MessageDigest messgeDigest = MessageDigest.getInstance("SHA-1");
                messgeDigest.update(s.getBytes());
                return toHexString(messgeDigest.digest());
    ...
    public static class SHA256 {
        public static String encryptAsString(String s) {
            try {
                MessageDigest messgeDigest = MessageDigest.getInstance("SHA-256");
                messgeDigest.update(s.getBytes());
                return toHexString(messgeDigest.digest());
            } catch (NoSuchAlgorithmException e) {
                e.printStackTrace();
        ...
        public static String encryptWithBase64(String s) {
            try {
                MessageDigest messgeDigest = MessageDigest.getInstance("SHA-256");
                messgeDigest.update(s.getBytes());
                return Base64.encodeToString(messgeDigest.digest(), Base64.NO_WRAP);
            } catch (NoSuchAlgorithmException e) {
                e.printStackTrace();
            }
    ...
    public static class HMACSHA256 {
        ...
        public static String encryptWithBase64(String secret, String message) {
            ...
            try {
                ...
                String hash = Base64.encodeToString(message.getBytes(), Base64.NO_WRAP);
                return hash;
            } catch (Exception e) {
                e.printStackTrace();
            }
